...
public class UserExportExcel {
    ...
    public UserExportExcel(List<Employee> listUsers) {
    ...
    private void writeHeaderLine() {
        sheet = workbook.createSheet("emps");
        ...
        createCell(row, 3, "fullanme", style);
    ...
    private void writeDataLines() {
        ...
        for (Employee e : listEmps) {
            ...
            createCell(row, columnCount++, e.getFname(), style);
            createCell(row, columnCount++, e.getLname(), style);
            createCell(row, columnCount++, e.getAge().toString(), style);
            createCell(row, columnCount++, e.getSalary().toString(), style);
